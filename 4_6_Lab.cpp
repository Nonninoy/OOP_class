...
public :
    ...
    class labtop : public computing_device {
        public:
            ...
            labtop(string n, processor p, float ram, input_device inp, string os) {
                name = n;
                cpu = p;
                ram_capacity = ram;
                input = inp;
    ...
    void print() {
        cout << name << " has [" << processing_power() << "] power with [" << input.name << "] input\n";
    }
};
class smartphone : public telephone, public computing_device {
public:
    string name;
    string operating_system ;

    smartphone(string n, processor p, float ram, input_device inp, string net) {
        name = n;
        cpu = p;
        ram_capacity = ram;
        input = inp;
    ...
    void print() {
        cout << name << " using [" << operating_system << "] with [" << network << "] network and running at ["<< processing_power() << "] power\n";
    }
};
